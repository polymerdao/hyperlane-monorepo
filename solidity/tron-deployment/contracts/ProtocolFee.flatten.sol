...
pragma solidity >=0.6.11 >=0.8.0 ^0.8.0 ^0.8.1;
...
// /Users/zhengyangfeng/repos/hyperlane-monorepo/node_modules/@openzeppelin/contracts/utils/Context.sol
...
contract ProtocolFee is AbstractPostDispatchHook, Ownable {
    ...
    constructor(
        ...
        // Validate protocol fee directly since immutable variables can't be read in constructor
        require(
            _protocolFee <= _maxProtocolFee,
